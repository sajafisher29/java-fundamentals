...
public class LinterTest {
    ...
    @Test public void correctOutput() {
        try {
            Scanner scanner = new Scanner(new File("/Users/sajaf/codefellows/java/javafundamentals/linter/src/main/resources/gates.js"));

            assertEquals("So many missing semicolons. Someone needs a new editor.",
